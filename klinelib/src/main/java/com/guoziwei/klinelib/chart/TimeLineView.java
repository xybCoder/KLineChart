...
//        mChartPrice.moveViewToX(combinedData.getEntryCount());
    ...
    private LineDataSet setLine(int type, ArrayList<Entry> lineEntries) {
        ...
        if (type == NORMAL_LINE) {
            ...
            lineDataSetMa.setFillColor(getResources().getColor(R.color.normal_line_color));//设置填充颜色
            lineDataSetMa.setFillAlpha(85);
    ...
    private void setOffset() {
        mChartPrice.setViewPortOffsets(0, 0, 0, DisplayUtils.dip2px(mContext, 20));
